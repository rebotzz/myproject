...
private:
	...
	std::unordered_map<std::string, SDL_Texture*> suf_image_pool;
...
public:
	...
	SDL_Texture* find_image(const std::string& id) const;
	...
	TTF_Font* find_font(const std::string& id = "IPix") const;
