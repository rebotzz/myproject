...
void init()
{
	try
	{
		...
		RegionMgr::instance()->add("takeout_box_1", new TakeoutBox(800, 570));
		RegionMgr::instance()->add("takeout_box_2", new TakeoutBox(900, 570));
		RegionMgr::instance()->add("takeout_box_3", new TakeoutBox(1000, 570));
		RegionMgr::instance()->add("takeout_box_4", new TakeoutBox(1100, 570));
		RegionMgr::instance()->add("takeout_box_5", new TakeoutBox(1200, 570));
	}
